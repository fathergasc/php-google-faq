...
<body>
    ...
    <header>
        <div class="header-top ps-3 pt-3 pe-3 d-flex justify-content-between">
            <div>
                <img src="https://www.gstatic.com/images/branding/googlelogo/svg/googlelogo_clr_74x24px.svg">
                <span class="mx-1 fs-5">Privacy e termini</span>
            </div>
            <div class="header-top-right">
                <a href="#" class="pe-3 text-black-50"><i class="fa-solid fa-grip"></i></a>
                <a href="#"><img class="rounded-circle" src="img/no-profile-picture-icon.png" alt=""></a>
                
            </div>
        </div>
        <nav class="navbar pe-3 pt-3 pb-3">
            <ul>
